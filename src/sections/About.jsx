...
const About = () => {
  return (
    <section id="about" className='h-screen min-h-250 bg-base-100 m-auto max-x-screen-md flex'>
      <div className='grid md:grid-cols-2 gap-12 w-full h-fit my-auto'>
        ...
        <div class="col-span-1 my-auto place-self-center md:place-self-start w-3/4 lg:w-125 ">
          <hgroup className='w-full'>
            ...
            <div>
              <a href='https://www.linkedin.com/in/dmai2025' className='w-fit inline-block' target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://github.com/Dav0M" className='w-fit inline-block ml-4' target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" className='size-12 transition ease-out duration-300 hover:scale-115' viewBox="0 0 128 128">
                  <g fill="#fff">
